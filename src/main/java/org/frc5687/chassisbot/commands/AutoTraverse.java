 ...
 */
public class AutoTraverse extends Command {
    /**
     *
     */
    ...
    public AutoTraverse(){
        ...
        inchesToCross = Constants.Autonomous.INCHES_TO_CROSS;
        rollThreshold = Constants.Autonomous.ROLL_THRESHOLD;

        speed = Constants.Autonomous.TRAVERSE_SPEED;
        if (imu==null) {
